...
{#if show}
    ...
    >
        <div
            ...
            class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full text-gray-800 dark:text-gray-100"
            role="dialog"
            aria-modal="true"
        ...
        >
            ...
            <div class="flex justify-end space-x-3">
                <PillButton
                    onClick={handleCancel}
                    customClass="px-4 py-2 rounded text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 dark:focus:ring-gray-400 focus:ring-opacity-50"
                >
                    {m.cancel_button()}
                </PillButton>
                <PillButton
